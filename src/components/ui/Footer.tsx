...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-300 pt-16 pb-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-5 space-y-4">
            <Link href="/" className="flex items-center gap-3">
              <div className="relative w-11 h-11 rounded-xl overflow-hidden border border-slate-700 p-1 bg-white shadow-sm">
                <Image
                  src="/ipewo2.jpeg"
                  alt="IPEWO Logo"
                  fill
